...
// WM8960 ADC/ADCDAT -> ESP32 I2S0 RX data input.
// BCLK/LRCLK are shared with the WM8960 playback path on I2S0.
#define PIN_WM8960_ADCDAT GPIO_NUM_9
...
#define SAMPLE_RATE_RX      16000   // WM8960 mic payload rate after downsampling
...
// Set to 1 to log WM8960 mic peak/large-step/drop diagnostics once per second.
#define WM8960_MIC_DIAG_LOG 0
